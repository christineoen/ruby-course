...
describe DoubleDog::SignIn do
  describe 'validation' do
    it "requires a non-nil username" do
      ...
      result = DoubleDog::SignIn.run(username: nil)
    ...
    it "requires a non-blank username" do
      ...
      result = DoubleDog::SignIn.run(username: '')
    ...
    it "it requires a non-nil password" do
      ...
      result = DoubleDog::SignIn.run(username: 'bob_man', password: nil)
    ...
    it "it requires a non-blank password" do
      ...
      result = DoubleDog::SignIn.run(username: 'malice_alice', password: '')
    ...
    it "requires the username to exist" do
      ...
      result = DoubleDog::SignIn.run(:username => "doesn't exist", :password => "doesn't exist")
    ...
    it "requires the password to match the username" do
      ...
      result = DoubleDog::SignIn.run(:username => user.username, :password => 'pillsbury')
  ...
  it "creates a sessions for the user" do
    ...
    result = DoubleDog::SignIn.run(:username => user.username, password: 'beer')
  ...
  it "retrieves a user from the created session" do
    ...
    result = DoubleDog::SignIn.run(:username => user.username, password: 'pass12')
